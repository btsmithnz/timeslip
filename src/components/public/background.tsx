...
export function PublicBackground() {
  ...
  return (
    <View className="absolute inset-0 overflow-hidden">
      ...
      <View className="absolute left-[8%] top-[20%] h-8 rounded-md md:hidden" style={{ width: "38%", backgroundColor: palette.accentSoft, opacity: 0.8 }} />
      <View className="absolute right-[8%] top-[20%] h-8 rounded-md md:hidden" style={{ width: "28%", backgroundColor: palette.surface, opacity: 0.9 }} />
      <View className="absolute left-[8%] top-[32%] h-8 rounded-md md:hidden" style={{ width: "56%", backgroundColor: palette.surface, opacity: 0.9 }} />
      <View className="absolute left-[8%] top-[44%] h-8 rounded-md md:hidden" style={{ width: "32%", backgroundColor: palette.surface, opacity: 0.8 }} />

      <View className="absolute left-0 right-0 top-0 h-40" style={{ backgroundColor: palette.background, opacity: 0.12 }} />
      <View className="absolute bottom-0 left-0 right-0 h-64" style={{ backgroundColor: palette.background, opacity: 0.55 }} />
    </View>
  );
}
